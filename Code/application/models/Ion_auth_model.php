...
class Ion_auth_model extends CI_Model
{
	...
	public function get_users_groups($id = FALSE)
	{
		...
		return $this->db->select($this->tables['users_groups'] . '.' . $this->join['groups'] . ' as id, ' . $this->tables['groups'] . '.show_with, ' . $this->tables['groups'] . '.all_users, ' . $this->tables['groups'] . '.permissions, ' . $this->tables['groups'] . '.name, ' . $this->tables['groups'] . '.description, ' . $this->tables['groups'] . '.assigned_users')
	...
	public function get_all_groups()
	{
		...
		$groups = $this->db->where('saas_id', 0)
			->or_where('saas_id', $saas_id)
			->get('groups')
			->result();
		return $groups;
	}
	...
	public function members()
	{
		...
		$this->db->where('groups.name !=', 'saas_admin');
