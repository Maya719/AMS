                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center mt-4 flex-wrap">
                                            <ul class="kanbanimg me-3">
                                                <li><img src="<?=base_url('assets2/images/profile/small/pic1.jpg')?>" alt=""></li>
                                                <li><img src="<?=base_url('assets2/images/profile/small/pic2.jpg')?>" alt=""></li>
                                                <li><img src="<?=base_url('assets2/images/profile/small/pic3.jpg')?>" alt=""></li>
                                                <li><img src="<?=base_url('assets2/images/profile/small/pic4.jpg')?>" alt=""></li>
                                                <li><img src="<?=base_url('assets2/images/profile/small/pic5.jpg')?>" alt=""></li>
                                                <li><span>5+</span></li>
                                            </ul>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row justify-content-between align-items-center kanban-user">
                                            <ul class="users col-6">
                                                ...
                                                <li><img src="<?=base_url('assets2/images/contacts/pic22.jpg')?>" alt=""></li>
                                                <li><img src="<?=base_url('assets2/images/contacts/pic33.jpg')?>" alt=""></li>
                                                <li><img src="<?=base_url('assets2/images/contacts/pic222.jpg')?>" alt=""></li>
                                            </ul>
                                            <div class="col-6 d-flex justify-content-end">
