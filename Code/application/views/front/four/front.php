                                ...
                                <div class="tp-header-2-right d-flex align-items-center">
                                    <div class="tp-header-btn d-none d-xl-block">
                                        <!-- <a class="tp-btn" href="<?= base_url('auth/register') ?>">
                                            Get it free</a> -->
                                        <a class="tp-btn x8oe2yx" type="button" data-bs-toggle="modal" data-bs-target="#authenticationModal">
                                            Get it free</a>
                                    </div>
                                        ...
                                        <form id="authenticationModalLogin" method="POST" action="<?= base_url('auth/login') ?>" class="needs-validation" novalidate="">
                                            ...
                                            <?php if (!turn_off_new_user_registration()) { ?>
                                                <div class="text-muted text-center ">
                                                    ...
                                                    <a style="cursor: pointer;" class="x8oe2yx"><?= $this->lang->line('create_one') ? $this->lang->line('create_one') : 'Create One' ?></a>
                                                </div>
                                            <?php } ?>
                                        ...
                                        <form id="register" method="POST" action="<?= base_url('auth/create_user') ?>" class="needs-validation" novalidate="">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-12" style="position: relative;">
                                                    ...
                                                    <i class="fa fa-eye password-toggle2" style="position: absolute; right: 30px; top: 68%; transform: translateY(-60%); cursor: pointer;"></i>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-12" style="position: relative;">
                                                    <label for="password2" class="d-block"><?= $this->lang->line('password_confirmation') ? $this->lang->line('password_confirmation') : 'Confirm' ?></label>
