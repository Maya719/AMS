...
<head>
  ...
  <meta property="og:description"
    content="<?= (isset($meta_description) && !empty($meta_description)) ? htmlspecialchars($meta_description) : htmlspecialchars($page_title) ?>" />
  ...
  <link href="<?= base_url('assets2/vendor/bootstrap-daterangepicker/daterangepicker.css') ?>" rel="stylesheet"
    type="text/css" />
  ...
  <link href="<?= base_url('assets2/vendor/jquery-asColorPicker/css/asColorPicker.min.css') ?>" rel="stylesheet"
    type="text/css" />

  <link href="<?= base_url('assets2/vendor/sweetalert2/sweetalert2.min.css') ?>" rel="stylesheet" type="text/css" />

  <link
    href="<?= base_url('assets2/vendor/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css') ?>"
    rel="stylesheet" type="text/css" />

  <link rel="stylesheet" href="<?= base_url('assets/modules/bootstrap-timepicker/timepicker.css') ?>">

  <link href="<?= base_url('assets2/vendor/bootstrap-datepicker-master/css/bootstrap-datepicker.min.css') ?>"
    rel="stylesheet" type="text/css" />
  ...
  <link href="<?= base_url('assets2/vendor/bootstrap-select/css/bootstrap-select.min.css') ?>" rel="stylesheet"
    type="text/css" />
