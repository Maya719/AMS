...
<script src="assets2/vendor/counter/counter.min.js"></script>
<script src="assets2/vendor/counter/waypoint.min.js"></script>
<script src="assets2/vendor/owl-carousel/owl.carousel.js"></script>
<script src="assets2/js/custom.min.js"></script>
<script src="assets2/js/dlabnav-init.js"></script>
...
<script src="<?=base_url('assets2/vendor/global/global.min.js')?>"></script>
      ...
      <script src="<?=base_url('assets2/vendor/pickadate/picker.date.js')?>"></script>
      <script src="<?=base_url('assets2/js/plugins-init/bs-daterange-picker-init.js')?>"></script>
      <script src="<?=base_url('assets2/js/plugins-init/clock-picker-init.js')?>"></script>
      <script src="<?=base_url('assets2/js/plugins-init/jquery-asColorPicker.init.js')?>"></script>
      <script src="<?=base_url('assets2/js/plugins-init/material-date-picker-init.js')?>"></script>
