                                            ...
                                            <select class="form-control select2" name="user">
                                                ...
                                                <?php foreach ($project_users as $project_user) {
                                                    if ($project_user->saas_id == $this->session->userdata('saas_id')) { ?>
                                                        <option value="<?= $project_user->id ?>" <?= ($project_user->id == $issues_users->user_id) ? 'selected' : '' ?>><?= htmlspecialchars($project_user->first_name) ?> <?= htmlspecialchars($project_user->last_name) ?></option>
                                                <?php }
                                                } ?>
                                            </select>
                                        </div>
