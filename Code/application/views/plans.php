                    ...
                    <table id="example3" class="table table-sm mb-0">
                      ...
                      <tbody>
                        <?php foreach ($plans as $plan) : ?>
                          ...
                          } elseif ($plan["billing_type"] == 'three_months_trial_plan') {
                            $billing_type = $this->lang->line('three_months_trial_plan') ? htmlspecialchars($this->lang->line('three_months_trial_plan')) : '3 months trial plan';
                          } elseif ($plan["billing_type"] == 'six_months_trial_plan') {
                            $billing_type = $this->lang->line('six_months_trial_plan') ? htmlspecialchars($this->lang->line('six_months_trial_plan')) : '6 months trial plan';
                          } else {
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6 mb-3">
                  ...
                  <select name="billing_type" id="billing_type" class="form-control select2">
                    ...
                    <option value="fifteen_days_trial_plan"><?= $this->lang->line('fifteen_days_trial_plan') ? htmlspecialchars($this->lang->line('fifteen_days_trial_plan')) : '15 days trial plan' ?></option>
                    <option value="thirty_days_trial_plan"><?= $this->lang->line('thirty_days_trial_plan') ? htmlspecialchars($this->lang->line('thirty_days_trial_plan')) : '30 days trial plan' ?></option>
                    <option value="three_months_trial_plan"><?= $this->lang->line('three_months_trial_plan') ? htmlspecialchars($this->lang->line('three_months_trial_plan')) : '3 months trial plan' ?></option>
                    <option value="six_months_trial_plan"><?= $this->lang->line('six_months_trial_plan') ? htmlspecialchars($this->lang->line('six_months_trial_plan')) : '6 months trial plan' ?></option>
                  </select>
                </div>
