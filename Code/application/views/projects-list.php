        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body d-flex justify-content-center">
              ...
              <input type="radio" id="radio1" name="image-radio" value="kanban" class="image-radio-input">
              ...
              <input type="radio" id="radio2" name="image-radio" value="agile" class="image-radio-input">
