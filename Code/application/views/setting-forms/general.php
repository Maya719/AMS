...
<div class="row">
  <div class="card">
    <div class="card-body">
      <form action="<?= base_url('settings/save-general-setting') ?>" method="POST" id="setting-form" enctype="multipart/form-data">
        <div class="card-body row">
          ...
          <?php if ($this->ion_auth->in_group(3)) { ?>
            ...
            <div class="form-group col-md-4 mt-3">
              <img alt="Full Logo" id="full_logo-img" src="<?= base_url('assets/uploads/logos/' . htmlspecialchars($full_logo)) ?>" style="height: 50px;" class="system-logos">
            ...
            <div class="form-group col-md-4 mt-3">
              <img alt="Half Logo" id="half_logo-img" src="<?= base_url('assets/uploads/logos/' . htmlspecialchars($half_logo)) ?>" style="height: 50px;" class="system-logos">
            ...
            <div class="form-group col-md-4 mt-3">
              <img alt="Favicon" id="favicon-img" src="<?= base_url('assets/uploads/logos/' . htmlspecialchars($favicon)) ?>" style="height: 50px;" class="system-logos">
        ...
        <?php if ($this->ion_auth->is_admin() || is_saas_admin() || permissions('general_edit')) { ?>
