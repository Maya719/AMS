        ...
        <form action="<?= base_url('settings/save-logins-setting') ?>" method="POST" id="language-form">
          ...
          <div class="card-body row">
            <div class="form-group col-md-12">
              <label class="col-form-label"><?= $this->lang->line('google_client_id') ? htmlspecialchars($this->lang->line('google_client_id')) : 'Google Client ID' ?></label>
            ...
            <div class="form-group col-md-12">
              <label class="col-form-label"><?= $this->lang->line('google_client_secret') ? htmlspecialchars($this->lang->line('google_client_secret')) : 'Google Client Secret' ?></label>
