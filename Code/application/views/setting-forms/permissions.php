    ...
    <div class="col-md-12">
      ...
      <div class="form-group mt-2 col-md-12">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="team_members_and_client_can_chat" name="team_members_and_client_can_chat" 
          value="<?= (isset($permissions->team_members_and_client_can_chat) && !empty($permissions->team_members_and_client_can_chat)) ? $permissions->team_members_and_client_can_chat : 0 ?>" 
          <?= (isset($permissions->team_members_and_client_can_chat) && !empty($permissions->team_members_and_client_can_chat) && $permissions->team_members_and_client_can_chat == 1) ? 'checked' : '' ?>>
