                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body row mb-3" id="show_div2">
                                <div class="form-group col-md-6">
                                    <label><?= $this->lang->line('apply') ? $this->lang->line('apply') : 'Apply ' ?> <i class="fas fa-question-circle" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('m') ? $this->lang->line('m') : 'Allow the sandwich will apply with?' ?>"></i></label>
