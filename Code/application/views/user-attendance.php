                ...
                <div class="basic-form">
                  <form class="row">
                    ...
                    <div id="custom-date-range" class="row" style="display: none;">
                      <div class="col-lg-3">
                        <input name="datepicker" class="datepicker-default form-control" placeholder="From Date" id="datepicker-1">
                      </div>
                      <div class="col-lg-3">
                        <input name="datepicker" class="datepicker-default form-control" placeholder="To Date" id="datepicker-2">
                      </div>
                    </div>
                  </form>
                </div>
...
function showTable(data) {
    ...
    data.forEach(user => {
        ...
        uniqueDates.forEach(date => {
            const formattedDate = new Date(date);
            const formattedDateString = formattedDate.toLocaleString('en-US', { weekday: 'short' }); // Use 'short' to get abbreviated day names
        ...
        userRow += '</tr>';
        userRow += '<tr>';
        userRow += '<th class="border-bottom-0 static-column-left" style="background: #FAFAFA; width: 2rem;">Time</th>';
